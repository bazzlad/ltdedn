...
<template>
    ...
    <div class="main-bg relative flex min-h-screen flex-col bg-black text-neutral-200 antialiased">
        ...
        >
            <div class="w-full rounded-2xl bg-white/5 p-8 ring-1 ring-white/10 backdrop-blur-sm">
                <div class="text-center">
                    <h1 class="text-2xl font-bold tracking-tight text-white">Password Required</h1>
                    <p class="mt-2 text-sm text-neutral-300">This page requires a password to access.</p>
                </div>
                    ...
                    <div>
                        ...
                        <div class="relative mt-2">
                            <input
                                ...
                                name="password"
                                required
                                class="block w-full rounded-xl border-0 bg-white/10 px-4 py-3 pr-12 text-white ring-1 ring-white/20 ring-inset placeholder:text-neutral-400 focus:bg-white/15 focus:ring-2 focus:ring-white/40 focus:ring-inset"
