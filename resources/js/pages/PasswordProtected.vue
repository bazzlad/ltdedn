                ...
                <form @submit.prevent="submit" class="mt-8 space-y-6">
                    <div>
                        ...
                        <input
                            ...
                            name="password"
                            required
                            class="mt-2 block w-full rounded-xl border-0 bg-white/10 px-4 py-3 text-white placeholder:text-neutral-400 ring-1 ring-inset ring-white/20 focus:bg-white/15 focus:ring-2 focus:ring-inset focus:ring-white/40"
